...
class ProductTable extends Component {
  ...
  handleDataFetch = (requestedPage, requestedRowsPerPage) => {
    ...
    this.props.queryModelData('Product',this.state.query,this.state.column, this.state.direction, requestedPage, requestedRowsPerPage, this.props.currentUser.user.company)
